...
# JNF
#python3 src/bivae/validate.py --model jnf/mnist_svhn

# JNF-DCCA 
#python3 src/bivae/validate.py --model jnf_dcca/mnist_svhn


########################################################################################################################
########################################### MNIST-SVHN-FashionMNIST ####################################################
########################################################################################################################
...
# JNF
# python3 src/bivae/validate.py --model jnf/msf

# JNF-DCCA 
#python3 src/bivae/validate.py --model jnf_dcca/msf
...
# JNF
# python3 src/bivae/validate.py --model jnf/celeba

# JNF-DCCA 
#python3 src/bivae/validate.py --model jnf_dcca/celeba
